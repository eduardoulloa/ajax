...
function actualizarPassword() {
	...
	var passwordNuevo = $("#newPassword").val();
	var passwordConfirmar = $("#conPassword").val();
	...
	$.post( BASE_PATH + "/inc/Ajax/_Login/cambiarPassword.php",
	{ idUsuario: idUsuario, passwordNuevo: passwordNuevo, passwordConfirmar: passwordConfirmar },
	function( respuesta ) {
		if ( respuesta.codigo == 0 ) {
			...
			$("#alerta").stop(true, true).fadeIn();
			window.location = BASE_PATH+"/inicio.php";
		} else {
